...
void init_matrix_keypad(void)
{
    ...
    MATRIX_KEYPAD_COLUMN_PORT_DDR = MATRIX_KEYPAD_COLUMN_PORT_DDR | 0x07;  //0000  0111 | xxxx xxxx - xxxx x111
    
    
    /* Setting the Rows as Output (RD3 - RD0)*/
    //xxxx xxxx & 1111 0000
    MATRIX_KEYPAD_ROW_PORT_DDR = MATRIX_KEYPAD_ROW_PORT_DDR & 0xF0; // 1111 0000 &  xxxx  xxxx = xxxx 0000
...
unsigned char read_matrix_keypad(unsigned char mode)
{
    ...
    key = scan_keypad(); //1 2 3 4 5 6 7 8 9 0 '*' '#' ALL_RELEASED
